...
public class BitmapRequest implements Comparable<BitmapRequest>{
    ...
    public void setImageUrlTag(String imageUrlTag) {
        this.imageUrlTag = imageUrlTag;
    }
    ...
    public BitmapRequest(ImageView imageView, String imageUrl, AbstractDisplay displayConfig,
        ...
        if (imageUrl != null) {
            imageUrlTag =imageUrl.substring(0,imageUrl.indexOf("?"));
            Log.e("======",imageUrlTag+"===");
            imageView.setTag(imageUrlTag);
            imageUrlMd5 = Md5Util.toMD5(imageUrlTag);
        }
